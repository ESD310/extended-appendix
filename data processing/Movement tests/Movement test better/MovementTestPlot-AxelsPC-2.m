...
data20 = readtable('C:\Users\axelo\OneDrive - Aalborg Universitet\General - ESD310\P3 Projekt\Tests\Movement test better\Test1_speed20.log', ...
    'Delimiter', ',', 'FileType', 'text', 'Format', '%f%f%f%f%f%f');
data40 = readtable('C:\Users\axelo\OneDrive - Aalborg Universitet\General - ESD310\P3 Projekt\Tests\Movement test better\Test2_speed40.log', ...
    'Delimiter', ',', 'FileType', 'text', 'Format', '%f%f%f%f%f%f');
data60 = readtable('C:\Users\axelo\OneDrive - Aalborg Universitet\General - ESD310\P3 Projekt\Tests\Movement test better\Test3_speed60.log', ...
    'Delimiter', ',', 'FileType', 'text', 'Format', '%f%f%f%f%f%f');
data80 = readtable('C:\Users\axelo\OneDrive - Aalborg Universitet\General - ESD310\P3 Projekt\Tests\Movement test better\Test4_speed80.log', ...
    'Delimiter', ',', 'FileType', 'text', 'Format', '%f%f%f%f%f%f');
data100 = readtable('C:\Users\axelo\OneDrive - Aalborg Universitet\General - ESD310\P3 Projekt\Tests\Movement test better\Test5_speed100.log', ...
    'Delimiter', ',', 'FileType', 'text', 'Format', '%f%f%f%f%f%f');
