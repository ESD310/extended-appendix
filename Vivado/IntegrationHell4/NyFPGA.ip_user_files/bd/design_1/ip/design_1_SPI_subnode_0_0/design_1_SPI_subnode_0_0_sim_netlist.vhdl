...
architecture STRUCTURE of design_1_SPI_subnode_0_0_SPI_subnode is
  ...
  signal in4 : STD_LOGIC_VECTOR ( 20 downto 0 );
  ...
  signal sck_prev_i_1_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of MISO_INST_0 : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of miso_reg_i_1 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of sck_falling_i_1 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of sck_prev_i_1 : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \shift_out[19]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \shift_out[1]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \shift_out[20]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \shift_out[21]_i_1\ : label is "soft_lutpair7";
...
sck_falling_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"F202"
    )
        port map (
...
sck_prev_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"E2"
    )
        port map (
...
sck_prev_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
...
\shift_out[21]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      I0 => current_state(1),
      I1 => \shift_out_reg_n_0_[20]\,
      O => shift_out(21)
    );
...
U0: entity work.design_1_SPI_subnode_0_0_SPI_subnode
     port map (
      ...
      X_pos(20 downto 0) => X_pos(20 downto 0),
      Y_pos(20 downto 0) => Y_pos(20 downto 0),
      Z_pos(20 downto 0) => Z_pos(20 downto 0)
    );
end STRUCTURE;
